...
class GraphCanvas3 extends JPanel {
	...
	class SortingAlgorithms {
		...
		public void countSort(int n) {
			...
			for(i = n -1; i >= 0; i--) {
				output[count[list[i]] - 1] = list[i];	acc++;  //BUILDING THE OUTPUT ARRAY
				count[list[i]]--;	acc++;
			}
			for(i = 0; i < n; i++) {
				if(!sorting)
	...
	class SortingAlgorithms2 {
		...
		public void countSort2(int n) {
			...
			for(i = n -1; i >= 0; i--) {
				output[count[list2[i]] - 1] = list2[i];	acc2++;  //BUILDING THE OUTPUT ARRAY
				count[list2[i]]--;	acc2++;
			}
			for(i = 0; i < n; i++) {
				if(!sorting)
	...
	class SortingAlgorithms3 {
		...
		public void countSort3(int n) {
			...
			for(i = n -1; i >= 0; i--) {
				output[count[list3[i]] - 1] = list3[i];	acc3++;  //BUILDING THE OUTPUT ARRAY
				count[list3[i]]--;	acc3++;
			}
			for(i = 0; i < n; i++) {
				if(!sorting)
	...
	class SortingAlgorithms4 {
		...
		public void countSort4(int n) {
			...
			for(i = n -1; i >= 0; i--) {
				output[count[list4[i]] - 1] = list4[i];	acc4++;  //BUILDING THE OUTPUT ARRAY
				count[list4[i]]--;	acc4++;
			}
			for(i = 0; i < n; i++) {
				if(!sorting)
	...
	class SortingAlgorithms5 {
		...
		public void countSort5(int n) {
			...
			for(i = n -1; i >= 0; i--) {
				output[count[list5[i]] - 1] = list5[i];	acc5++;  //BUILDING THE OUTPUT ARRAY
				count[list5[i]]--;	acc5++;
			}
			for(i = 0; i < n; i++) {
				if(!sorting)
	...
	class SortingAlgorithms6 {
		...
		public void countSort6(int n) {
			...
			for(i = n -1; i >= 0; i--) {
				output[count[list6[i]] - 1] = list6[i];	acc6++;  //BUILDING THE OUTPUT ARRAY
				count[list6[i]]--;	acc6++;
			}
			for(i = 0; i < n; i++) {
				if(!sorting)
